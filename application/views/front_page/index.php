...
<head>
  ...
  <link href="<?php echo base_url('assets/template-user/img/apple-touch-icon.png') ?>" rel="apple-touch-icon">

  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Jost:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">

  <!-- Vendor CSS Files -->
  <link href="<?php echo base_url('assets/template-user/vendor/aos/aos.css') ?>" rel="stylesheet">
  <link href="<?php echo base_url('assets/template-user/vendor/bootstrap/css/bootstrap.min.css') ?>" rel="stylesheet">
  <link href="<?php echo base_url('assets/template-user/vendor/bootstrap-icons/bootstrap-icons.css') ?>" rel="stylesheet">
  <link href="<?php echo base_url('assets/template-user/vendor/boxicons/css/boxicons.min.css') ?>" rel="stylesheet">
  <link href="<?php echo base_url('assets/template-user/vendor/glightbox/css/glightbox.min.css') ?>" rel="stylesheet">
  <link href="<?php echo base_url('assets/template-user/vendor/remixicon/remixicon.css') ?>" rel="stylesheet">
  <link href="<?php echo base_url('assets/template-user/vendor/swiper/swiper-bundle.min.css') ?>" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top ">
    ...
    <a href="index.html" class="logo me-auto"><img src="<?php echo base_url('assets/template-user/img/logo.png') ?>" alt="" class="img-fluid"></a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#services"><span>Informasi Publik</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="#">Sejarah Kelurahan</a></li>
              <li><a href="#">Struktur Kelurahan</a></li>
              <li><a href="#">Visi & Misi</a></li>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="zoom-in">
          ...
          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo base_url('assets/template-user/img/clients/client-1.png') ?>" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo base_url('assets/template-user/img/clients/client-2.png') ?>" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo base_url('assets/template-user/img/clients/client-3.png') ?>" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo base_url('assets/template-user/img/clients/client-4.png') ?>" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src=<?php echo base_url('"assets/template-user/img/clients/client-5.png') ?>" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo base_url('assets/template-user/img/clients/client-6.png') ?>" class="img-fluid" alt="">
          </div>
  ...
  <!-- Vendor JS Files -->
  <script src="<?php echo base_url('assets/template-user/vendor/aos/aos.js') ?>"></script>
  <script src="<?php echo base_url('assets/template-user/vendor/bootstrap/js/bootstrap.bundle.min.js') ?>"></script>
  <script src="<?php echo base_url('assets/template-user/vendor/glightbox/js/glightbox.min.js') ?>"></script>
  <script src="<?php echo base_url('assets/template-user/vendor/isotope-layout/isotope.pkgd.min.js') ?>"></script>
  <script src="<?php echo base_url('assets/template-user/vendor/swiper/swiper-bundle.min.js') ?>"></script>
  <script src="<?php echo base_url('assets/template-user/vendor/waypoints/noframework.waypoints.js') ?>"></script>
  <script src="<?php echo base_url('assets/template-user/vendor/php-email-form/validate.js') ?>"></script>

  <!-- Template Main JS File -->
  <script src="<?php echo base_url('assets/template-user/js/main.js') ?>"></script>
