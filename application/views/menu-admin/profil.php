                ...
                <div class="col-lg-12">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-6">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="image" id="image"
                                            onchange="previewImage1(event, 'imageProfil')">
                            ...
                            <div class="row mb-1">
                                <label for="ktp" class="col-sm-2 col-form-label">Foto</label>
                                <div class="col-sm-6">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="ktp" id="ktp"
                                            onchange="previewImage1(event, 'imageKTP')">
                            ...
                            <div class="row mb-1">
                                <div class="col-sm-6">
                                    <button type=" button" id="btn-ubah" onclick="edit_profil()"
                                        class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> Simpan</button>
                                </div>
                            </div>
                        </div>
                    </div>
