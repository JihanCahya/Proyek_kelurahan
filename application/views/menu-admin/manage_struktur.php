<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" onclick="submit('tambah')"> <i class="mdi mdi-plus-circle"></i> Input data</button>
                ...
                <div class="col-sm-3">
                    ...
                    <select id="filter" name="filter[]" class="form-control">
                        ...
                        <?php foreach ($select as $row) : ?>
                            <option value="<?php echo $row->name_bridge; ?>"><?php echo $row->name_bridge; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div><br>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-10">
                                                <select id="bridge" name="bridge[]" class="form-control">
                                                    <?php foreach ($select as $row) : ?>
                                                        <option value="<?php echo $row->id_bridge; ?>"><?php echo $row->name_bridge; ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
